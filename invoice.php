...
// Cek apakah booking_id ada di sesi
if (!isset($_SESSION['last_booking_id'])) {
    header("HTTP/1.1 404 Not Found");
    include('error_page.php');  // Sertakan halaman error
    exit;
}
...
$booking_details = $result->fetch_assoc(); // Ambil detail booking dari tabel tiket
...
while ($row = $result_seats->fetch_assoc()) {
    $seats[] = $row['kursi']; // Tambahkan setiap kursi ke dalam array kursi
}
...
<div class="container booking-history">
    ...
    <a href="bioskop.php" class="back-btn"><i class='bx bx-arrow-back'></i></a>
